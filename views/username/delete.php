...
<form action="" method="POST" autocomplete="off">
    <div class="mb-3">
        ...
        <label for="exampleInputEmail1" class="form-label">Status (Disponible/Vendido/Apartado)</label>
        <input type="text" name="Status" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        <label for="exampleInputEmail1" class="form-label">Precio $ (Sólo Numeros)</label>
